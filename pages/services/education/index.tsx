...
const EducationOverview: React.FC = () => {
  ...
  const svc = (servicesMetadata as any).services?.education;
        ...
        <div className="mb-6 p-6 bg-primary-darker rounded border border-white/5">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-2">
              <button onClick={() => navigate('/services/education/Apply')} className="px-3 py-2 bg-glow-blue rounded text-white">Apply / Admissions</button>
            </div>
          </div>
