...
const FinancialOverview: React.FC = () => {
  ...
  const svc = (servicesMetadata as any).services?.['financial-assistance'];
        ...
        <div className="mb-6 p-6 bg-primary-darker rounded border border-white/5">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-2">
              <button onClick={() => navigate('/services/financial-assistance/Apply')} className="px-3 py-2 bg-glow-blue rounded text-white">Apply for Aid</button>
            </div>
          </div>
