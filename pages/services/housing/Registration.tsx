...
const RegistrationPage: React.FC = () => {
  ...
  const meta = (servicesMetadata as any).services?.housing?.sections?.registration;
  ...
  return (
    <div className="py-16">
      <div className="container mx-auto px-4">
        ...
        <h1 className="text-2xl font-bold text-white mb-4">{meta?.title ?? 'Property Registration'}</h1>
        ...
        <div className="mt-6">
          <button onClick={() => navigate('/services/housing/Apply')} className="px-4 py-2 bg-glow-blue rounded text-white">Start Registration</button>
        </div>
      </div>
    </div>
  );
