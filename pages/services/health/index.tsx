...
const HealthOverview: React.FC = () => {
  ...
  const svc = (servicesMetadata as any).services?.health;
        ...
        <div className="mb-6 p-6 bg-primary-darker rounded border border-white/5">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-2">
              <button onClick={() => navigate('/services/health/Apply')} className="px-3 py-2 bg-glow-blue rounded text-white">Book Appointment</button>
              <button onClick={() => navigate('/services/health/confirmation')} className="px-3 py-2 bg-white/5 rounded text-white">View Confirmation</button>
            </div>
          </div>
